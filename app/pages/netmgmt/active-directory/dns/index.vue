...
<template>
  <div>
    <PageHeader title="NetMgmt / Active Directory / DNS Zones" description="Zone DNS AD-integrated -- dicari di ketiga kemungkinan partisi (Forest/Domain/Legacy) sekaligus." />
    <Card>
          ...
          <TableRow v-for="zone in data?.results" :key="zone.dn" v-else>
            ...
            <TableCell>
              <div class="flex justify-end">
                <NuxtLink :to="`/netmgmt/active-directory/dns/${encodeURIComponent(zone.dn)}`" class="inline-flex items-center gap-1.5 text-xs font-medium text-primary hover:underline">
