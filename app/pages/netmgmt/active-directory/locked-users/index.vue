...
<template>
  <div>
    <PageHeader title="NetMgmt / Active Directory / Locked Users" description="User yang TERKUNCI OTOMATIS krn salah password berkali-kali -- beda dari user yang dinonaktifkan manual (lihat halaman Users)." />
    <Card>
