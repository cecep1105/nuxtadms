...
/**
 * Versi Portal dari AD Users -- SAMA endpoint dgn staff, TANPA
 * AddAdUserDialog (SENGAJA -- bikin user AD baru TETAP staff-only,
 * tidak diperluas ke izin portal can_view_ad_users).
 */
const PAGE_SIZE = 20
...
<template>
  <div>
    <PageHeader title="Active Directory - Users">
