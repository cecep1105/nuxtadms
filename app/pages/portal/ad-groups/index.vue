 ...
 * & kelola keanggotaan TETAP staff-only, tidak diperluas ke izin
 * portal can_view_ad_groups.
 */
const PAGE_SIZE = 20
...
<template>
  <div>
    <PageHeader title="Active Directory - Groups">
