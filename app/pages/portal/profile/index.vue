...
import { Loader2, KeyRound, ArrowLeft } from "@lucide/vue"
import type { DjangoApiUser } from "#shared/types/api"

/**
 * Profil Saya versi Portal -- SAMA logic dgn versi staff (app/pages/profile/index.vue),
 * BEDA: link "Kembali ke Menu" (bukan Topbar sidebar), TANPA badge
 * Staff/Superuser (user portal, per definisi, tidak staff/superuser).
 */
...
const { data: user, pending } = await useAsyncData("portal-profile-me", () => request<DjangoApiUser>("/me/"))
